<template>
    <div class="attchment">
        <div class="attchment-toolbar">
            ...
            <Icon type="md-trash"  size="20" title="回收站"  @click="handleShowDeleted" :color="showDeleted?'#2d8cf0':'#2c3e50'" />
        </div>
...
export default {
    ...
    methods:{
        ...
        getAttachment(){
            ...
            this.showSpin = true;
            getProjectFiles({
                transCode:this.transCode?this.transCode:this.$route.params.transCode,
                ...this.params,
            }).then(res => {
                this.showSpin = false;
