...
//获取点检表数据
export const listCheckKeyTable = (currentPage,limit) =>  request('/H_roleplay-si/check/listCheckTable',{
    page: currentPage,
    limit: limit
});

//获取点检表项目数据
export const listCheckContent = (checkKeyId,currentPage,limit) =>  request('/H_roleplay-si/check/listCheckItem',{
