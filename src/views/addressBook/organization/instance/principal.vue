...
<template>
  <div class="principalwarp">
    <custom-table
      apiUrl="/ds/getPrincipalByGroupId"
      :columns="principalColumns"
      :apiParams="principalParams"
      v-model="reload"
              ...
              h("Avatar", {
                props: {
                  src: params.row.photo
                    ? params.row.photo
                    : "https://lab.roletask.com/resource/common-icon/male.png"
                },
                on:{
                  'on-error': (e) => {
