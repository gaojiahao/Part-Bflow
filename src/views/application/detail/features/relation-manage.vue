        ...
        <div class="relation-body">
          ...
          <Table border stripe :columns="columns" :data="data">
            <template slot-scope="{ row }" slot="value">
                ...
                <Select v-else v-model="row.value" transfer style="width:200px">
            ...
            <template slot-scope="{ row }" slot="cashFlowName">
                ...
                <Select v-else v-model="row.cashFlowName" @on-change="onSelectChange(row,$event)" transfer style="width:200px">
