      ...
      <div class="svg_box" @click="outBlur">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1">
          ...
          <g v-for="(point) in pointList" :key="point.id">
            <polyline :points="point.value" :marker-end="waterFlow[point.id]!==undefined?'url(#arrow_hight_color)':'url(#arrow1)'" v-bind:class="waterFlow[point.id]!==undefined?'path':''" style="fill:none;stroke:transparent;stroke-width:1" />
          </g>
          <!-- 应用与应用之间的关系 -->
