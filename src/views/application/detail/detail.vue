...
<template>
  <div class="app-details">
    ...
    <!-- 应用详情信息 -->
    <app-info :listId="this.$route.params.listId" :enforData="enforData" :isAdmin="isAdmin" :isCompanyAdmin="isCompanyAdmin" :appData="appData" @reloadData="reloadData" @changeAdmin="changeAdmin" @enabledForbiddenAppPermission="enabledForbiddenAppPermission">
    </app-info>
    ...
    <div class="rfd-tab">
      <Tabs value="name1" class="rfd-tab-warp">
        ...
        <TabPane :disabled="!(isAdmin || isCompanyAdmin)" :label="(isAdmin || isCompanyAdmin)?'资源':''" name="name4">
          <permission-source :appType="appType" :isAdmin="isAdmin" :isAddress="isAddress" :enabledForbidden="enabledForbidden">
          </permission-source>
        </TabPane>
...
import Process from "./tabs/permission/process/process";
